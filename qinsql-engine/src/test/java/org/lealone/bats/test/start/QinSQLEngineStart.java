...
public class QinSQLEngineStart extends NodeBase {

    // YamlConfigLoader的子类必须有一个无参数的构造函数
    public QinSQLEngineStart() {
    ...
    public static void main(String[] args) throws Exception {
        NodeBase.run(QinSQLEngineStart.class, null);
    }

    public static void enableBatsServer(Config config) {
        enableProtocolServer(config, QinSQLEngine.NAME, Constants.DEFAULT_TCP_PORT);
    }
